...
public class Console
{
    ...
    @Autowired
    public Console(
            EntityService<Movie> movieService,
            EntityService<Client> clientService,
            EntityService<Rental> rentalService,
    ...
    private void initialize_menu()
    {
        ...
        menu.addCommand("Add movie", () ->
        {
            ...
            CompletableFuture.supplyAsync(()->{
                return this.movieService.addEntity(Objects.requireNonNull(inputMovie));
            }).thenAccept(movie -> System.out.println("Added movie: " + movie));

        });
        menu.addCommand("Show all movies", () ->
        {
            CompletableFuture.supplyAsync(()->{
                return this.movieService.getAllEntities(null);
        ...
        menu.addCommand("Update movie", () ->
        {
            ...
            CompletableFuture.supplyAsync(()->{
                return this.movieService.updateEntity(newMovie);
        ...
        menu.addCommand("Delete movie", () ->
        {
            ...
            CompletableFuture.supplyAsync(()->{
                return this.movieService.deleteEntity(deleteMovieId);
            }).thenAccept(movie -> System.out.println("Updated movie: " + movie));
        ...
        {
            CompletableFuture.supplyAsync(()->{
                return this.movieService.filter(filterEntities(Movie.class));
            }).thenAccept( movies ->  movies.forEach(System.out::println));

        });
        menu.addCommand("Show all movies sorted", () ->
        {
            ...
            CompletableFuture.supplyAsync(()->{
                return this.clientService.getAllEntities(sort);
        ...
        menu.addCommand("Add client", () ->
        {
            ...
            CompletableFuture.supplyAsync(()->{
                return this.clientService.addEntity(inputClient);
        ...
        {
            CompletableFuture.supplyAsync(()->{
                return this.clientService.getAllEntities(null);
            }).thenAccept( clients -> clients.forEach(System.out::println));
        ...
        menu.addCommand("Update client", () ->
        {
            ...
            CompletableFuture.supplyAsync(()->{
                return this.clientService.updateEntity(newClient);
        ...
        menu.addCommand("Delete Client", () ->
        {
            ...
            CompletableFuture.supplyAsync(()->{
                return this.clientService.deleteEntity(deleteClientId);
        ...
        {
            CompletableFuture.supplyAsync(()->{
                return this.clientService.filter(filterEntities(Client.class));
            }).thenAccept( clients -> clients.forEach(System.out::println));
        ...
        menu.addCommand("Rent movie", () ->
        {
            ...
            CompletableFuture.supplyAsync(()->{
                return this.rentalService.addEntity(new_rental);
        ...
        menu.addCommand("Return movie", () ->
        {
            ...
            CompletableFuture.supplyAsync(()->{
                return this.rentalService.updateEntity(rental);
        ...
        {
            CompletableFuture.supplyAsync(()->{
                return this.rentalService.getAllEntities(null);
        ...
        menu.addCommand("Report top clients", () ->
        {
            ...
            CompletableFuture.supplyAsync(()->{
                return this.reportingService.getTopClients(finalLimit);
            }).thenAccept( clients -> clients.forEach(System.out::println));
